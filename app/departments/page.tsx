...
const DEPARTMENTS = [
  ...
  {
    name: "Pediatrics",
    tagline: "Child Health & Newborn Care",
    icon: <Baby size={26} />,
    color: "#e07020",
    slug: "pediatrics",
  ...
  {
    name: "Psychiatry",
    tagline: "Mental Health & Psychotherapy",
    icon: <Brain size={26} />,
    color: "#8e44ad",
    slug: "psychiatry",
...
const FEATURED_DEPTS = [
  {
    title: "Orthopedic",
    sub: "Srikara Hospitals is Hyderabad's leading centre for Robotic Joint Replacement Surgery. Our orthopedic team across all 5 branches specialises in knee & hip replacement, arthroscopy, sports injuries and complex trauma — with faster recovery and precision outcomes.",
    img: "https://images.unsplash.com/photo-1706777193603-76c3e9613553?q=80&w=900&auto=format&fit=crop",
    tag: "No.1 Robotic Joint Replacement",
    reverse: false,
    href: "/departments/orthopedic",
  },
  {
    title: "Neurology & Neuro Surgery",
    sub: "From stroke management and epilepsy care to complex brain tumour surgeries and minimally invasive spine procedures — our neurosciences team brings together top neurologists and neurosurgeons across all Srikara branches.",
    img: "https://images.unsplash.com/photo-1559757175-5700dde675bc?w=900&q=88&auto=format&fit=crop",
    tag: "Brain & Spine Specialists",
    reverse: true,
    href: "/departments/neurology",
  },
  {
    title: "Cardiology",
    sub: "Our cardiologists at Lakdikapul, Kompally, ECIL, LB Nagar and Peerazdiguda provide comprehensive heart care — interventional cardiology, ECG, echocardiography, hypertension management and preventive cardiac screening.",
    img: "https://images.unsplash.com/photo-1559757296-5c84adc6d116?q=80&w=900&auto=format&fit=crop",
    tag: "Heart Care Across 5 Branches",
    reverse: false,
...
const DOCTORS = [
  ...
  },
  {
    ...
    dept: "Orthopedics",
    exp: "12+ Years",
    img: "/Ladikapul/DR.BHANUPRATAPP.png",
    color: "#C0145C",
    branch: "Lakdikapul",
    slug: "bhanu-pratap-p",
  },
  ...
  },
  {
    ...
    dept: "Nephrology",
    exp: "13+ Years",
    img: "/Ladikapul/DR.VAISHNAVI.png",
    color: "#6b4ea8",
    branch: "Lakdikapul",
    slug: "vaishnavi-p",
  },
      ...
      <Link href={`/departments/${dept.slug}`}>
        <div
          ...
          style={{
            ...
            borderRadius: 22,
            overflow: "hidden",
            border: hovered ? `1.5px solid ${dept.color}` : "1px solid #EDE8F0",
            cursor: "pointer",
            transform: hovered ? "translateY(-7px)" : "translateY(0)",
            boxShadow: hovered
              ? `0 24px 48px ${dept.color}22`
        ...
        >
          ...
          <div style={{ padding: "14px 16px 12px" }}>
            <h3 style={{
              ...
              fontSize: 16, fontWeight: 700, color: "#1C2B4A", marginBottom: 3,
            }}>
              {dept.name}
            </h3>
...
export default function DepartmentsPage() {
  ...
  const filtered = DEPARTMENTS.filter((d) => {
    ...
    const matchFilter =
      activeFilter === "All" || (FILTER_MAP[activeFilter] || []).includes(d.name);
  ...
  return (
    <>
      ...
      <div style={{ background: "#F8F6F9", minHeight: "100vh" }}>
        ...
        {/* ── §1 HERO ── */}
        <section style={{
          position: "relative", overflow: "hidden", background: "#1C2B4A",
          ...
          <div style={{
            ...
            borderRadius: "50%", background: "#C0145C", opacity: 0.08,
            filter: "blur(100px)", pointerEvents: "none",
          }} />

          <div style={{
            maxWidth: 1300, margin: "0 auto", padding: "100px 8vw 80px",
            ...
            <div>
              ...
              <div className="dp-hero-h1" style={{
                fontSize: 10, fontWeight: 800, letterSpacing: "0.4em",
                textTransform: "uppercase", color: "#C0145C", marginBottom: 14,
              }}>
                Srikara Hospitals · 5 Branches
              </div>

              <h1 className="dp-hero-h1" style={{
                fontFamily: "'Cormorant Garamond', Georgia, serif",
              ...
              <p className="dp-hero-sub" style={{
                fontSize: 15, color: "rgba(255,255,255,0.58)", lineHeight: 1.82,
                marginBottom: 36, maxWidth: 460, fontWeight: 300,
              }}>
                Expert specialists across ECIL, Kompally, LB Nagar, Lakdikapul and Peerazdiguda.
                Advanced care, compassionate doctors, exceptional outcomes — all under one roof.
              </p>
              ...
              <div className="dp-hero-btns" style={{ display: "flex", gap: 14, flexWrap: "wrap", marginBottom: 44 }}>
                <Link href="/doctors">
                  <button style={{
                    ...
                    border: "none", cursor: "pointer", boxShadow: "0 8px 24px rgba(192,20,92,0.38)",
                    transition: "transform 0.25s, box-shadow 0.25s",
                  }}
                    onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 14px 32px rgba(192,20,92,0.5)"; }}
                    onMouseLeave={e => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 8px 24px rgba(192,20,92,0.38)"; }}
                  >
                ...
                <a href="tel:04046460000">
                  <button style={{
                    display: "inline-flex", alignItems: "center", gap: 8,
                    padding: "12px 24px", borderRadius: 50, background: "transparent",
                    color: "#fff", fontFamily: "'Outfit',sans-serif", fontWeight: 700,
                    fontSize: 12, letterSpacing: "0.09em", textTransform: "uppercase",
                    border: "2px solid rgba(255,255,255,0.28)", cursor: "pointer", transition: "background 0.22s",
                  }}
              ...
              {/* Stats */}
              <div className="dp-hero-stats" style={{ display: "flex", gap: 32, flexWrap: "wrap" }}>
                {[
                  { n: "21+", l: "Departments" },
                  { n: "76+", l: "Specialists" },
                  { n: "5", l: "Branches" },
            ...
            {/* Right image mosaic */}
            <div className="dp-hero-img" style={{
              display: "grid", gridTemplateColumns: "1fr 1fr",
              gridTemplateRows: "230px 180px", gap: 12,
            }}>
              <div className="dp-img-zoom" style={{ gridRow: "1/3", borderRadius: 24, overflow: "hidden", position: "relative" }}>
                <img src="https://images.unsplash.com/photo-1706777193603-76c3e9613553?q=80&w=600&auto=format&fit=crop" alt="Orthopedic"
                  style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
                <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to top, rgba(28,43,74,0.7) 0%, transparent 55%)" }} />
                <span style={{
                  position: "absolute", bottom: 14, left: 14, fontSize: 9, fontWeight: 800,
                  textTransform: "uppercase", letterSpacing: "0.16em", padding: "5px 12px",
                  borderRadius: 50, background: "rgba(192,20,92,0.85)", color: "#fff",
                }}>Robotic Surgery</span>
              </div>
              <div className="dp-img-zoom" style={{ borderRadius: 24, overflow: "hidden" }}>
                <img src="https://images.unsplash.com/photo-1559757296-5c84adc6d116?q=80&w=500&auto=format&fit=crop" alt="Cardiology"
                  style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
              </div>
              <div className="dp-img-zoom" style={{ borderRadius: 24, overflow: "hidden", position: "relative" }}>
                <img src="https://images.unsplash.com/photo-1576091160550-2173dba999ef?q=80&w=500&auto=format&fit=crop" alt="Physiotherapy"
                  style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
          ...
          <div style={{ display: "flex", width: "max-content", animation: "dp-marquee 28s linear infinite" }}>
            {[...Array(2)].map((_, ri) =>
              ["Orthopedic", "Cardiology", "Neurology", "Neuro Surgery", "General Surgery", "Nephrology", "Urology", "Physiotherapy", "Plastic Surgery", "ENT", "Dermatology", "Psychiatry"].map(dept => (
                <span key={`${ri}-${dept}`} style={{
                  display: "inline-flex", alignItems: "center", gap: 12, marginRight: 40,
          ...
          <div style={{ maxWidth: 1300, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 72, alignItems: "center" }}>
            <FadeUp>
              <div className="dp-img-zoom" style={{ borderRadius: 28, overflow: "hidden", height: 460, position: "relative" }}>
                <img src="/department.jpeg" alt="Srikara Hospitals"
                  style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
                ...
                <div style={{ position: "absolute", bottom: 28, left: 28, right: 28 }}>
                  <div style={{
                    ...
                    border: "1px solid rgba(255,255,255,0.2)", borderRadius: 18, padding: "16px 20px",
                    display: "flex", gap: 20,
                  }}>
            ...
            <FadeUp delay={120}>
              <div>
                <div style={{ fontSize: 10, fontWeight: 800, letterSpacing: "0.38em", textTransform: "uppercase", color: "#C0145C", marginBottom: 12 }}>
                  Srikara Hospitals — Hyderabad
                </div>
                <h2 style={{ fontFamily: "'Cormorant Garamond',Georgia,serif", fontSize: "clamp(26px,3vw,42px)", fontWeight: 700, color: "#1C2B4A", lineHeight: 1.18, marginBottom: 18 }}>
                  Expert Care Across<br />
                  <em style={{ color: "#0A7A6A", fontStyle: "italic", fontWeight: 400 }}>5 Branches in Hyderabad</em>
                </h2>
                <p style={{ fontSize: 14, color: "#6B7280", lineHeight: 1.9, marginBottom: 14 }}>
                  From Robotic Joint Replacement to Interventional Cardiology, Neuro Surgery
                  to Nephrology — Srikara Hospitals delivers specialist-led care across ECIL,
                  Kompally, LB Nagar, Lakdikapul and Peerazdiguda.
                </p>
                <p style={{ fontSize: 14, color: "#6B7280", lineHeight: 1.9, marginBottom: 32 }}>
                  Our doctors focus on early diagnosis, precision treatment and faster
                  recovery — so you can get back to living your best life sooner.
                </p>

                {[
                  "No.1 Robotic Knee Replacement in Hyderabad",
                  "76+ specialist doctors across 5 branches",
                  "21 departments under one hospital network",
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 14, marginTop: 32 }}>
                  {[
                    { n: "21+", l: "Departments", c: "#C0145C" },
                    { n: "76+", l: "Doctors", c: "#1C2B4A" },
                    { n: "5", l: "Branches", c: "#0A7A6A" },
                  ].map(s => (
        ...
        <section style={{ background: "#F8F6F9" }}>
          <div style={{ maxWidth: 1300, margin: "0 auto", padding: "80px 8vw 0" }}>
            <FadeUp>
              <div style={{ textAlign: "center", marginBottom: 56 }}>
                <div style={{ fontSize: 10, fontWeight: 800, letterSpacing: "0.38em", textTransform: "uppercase", color: "#C0145C", marginBottom: 10 }}>
                  Centres of Excellence
                </div>
                <h2 style={{ fontFamily: "'Cormorant Garamond',Georgia,serif", fontSize: "clamp(26px,3vw,42px)", fontWeight: 700, color: "#1C2B4A" }}>
                  Our Flagship{" "}
                  <em style={{ color: "#0A7A6A", fontStyle: "italic", fontWeight: 400 }}>Specialties</em>
                </h2>
              </div>
            </FadeUp>
          </div>
          ...
          {FEATURED_DEPTS.map((item, i) => {
            const textBlock = (
              <div style={{
                padding: "64px 6vw", background: i % 2 === 0 ? "#fff" : "#F8F6F9",
                display: "flex", flexDirection: "column", justifyContent: "center",
              }}>
                <span style={{
                  display: "inline-block", fontSize: 9, fontWeight: 800, letterSpacing: "0.18em",
                  textTransform: "uppercase", padding: "5px 14px", borderRadius: 50,
                  background: "rgba(192,20,92,0.1)", color: "#C0145C", marginBottom: 18, width: "fit-content",
                }}>{item.tag}</span>
                <h3 style={{ fontFamily: "'Cormorant Garamond',Georgia,serif", fontSize: 34, fontWeight: 700, color: "#1C2B4A", lineHeight: 1.18, marginBottom: 16 }}>{item.title}</h3>
                <p style={{ fontSize: 14, color: "#6B7280", lineHeight: 1.9, marginBottom: 28 }}>{item.sub}</p>
                <Link href={item.href}>
                  <span style={{ display: "inline-flex", alignItems: "center", gap: 8, fontSize: 12, fontWeight: 800, color: "#C0145C", letterSpacing: "0.06em", textTransform: "uppercase", cursor: "pointer" }}>
            ...
            const imgBlock = (
              <div className="dp-img-zoom" style={{ height: 400, overflow: "hidden" }}>
            ...
            <FadeUp>
              <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", flexWrap: "wrap", gap: 24, marginBottom: 44 }}>
                ...
                <div style={{ position: "relative", width: 300 }}>
                  ...
                  <input className="dp-search" type="text" placeholder="Search departments..."
              ...
              <div style={{ display: "flex", gap: 8, marginBottom: 36, flexWrap: "wrap" }}>
                {FILTERS.map(f => (
                  <button key={f} className={`dp-filter-btn ${activeFilter === f ? "active" : "inactive"}`} onClick={() => setActiveFilter(f)}>{f}</button>
                ))}
              </div>
            </FadeUp>
          ...
          <div style={{ maxWidth: 1300, margin: "0 auto" }}>
            <FadeUp>
              <div style={{ textAlign: "center", marginBottom: 52 }}>
                ...
                <p style={{ fontSize: 14, color: "#6B7280", marginTop: 12, maxWidth: 440, margin: "12px auto 0", lineHeight: 1.8 }}>
                  76+ dedicated doctors across 5 Srikara branches in Hyderabad.
                </p>
              </div>
            </FadeUp>
                    ...
                    <div style={{ padding: "18px 18px 16px" }}>
                      ...
                      <Link href={`/doctors/${doc.slug}`}>
                        <button style={{
                          ...
                          cursor: "pointer", boxShadow: "0 4px 14px rgba(192,20,92,0.28)",
                          transition: "transform 0.22s, box-shadow 0.22s",
                        }}
                          onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 8px 22px rgba(192,20,92,0.4)"; }}
                          onMouseLeave={e => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 4px 14px rgba(192,20,92,0.28)"; }}
                        >
                          Book Appointment
                        </button>
                      </Link>
            ...
            <FadeUp delay={200}>
              <div style={{ textAlign: "center", marginTop: 44 }}>
                <Link href="/doctors">
                  <button style={{
                    display: "inline-flex", alignItems: "center", gap: 8,
                    padding: "13px 32px", borderRadius: 50, background: "transparent",
                    color: "#1C2B4A", fontFamily: "'Outfit',sans-serif", fontWeight: 800,
                    fontSize: 12, letterSpacing: "0.09em", textTransform: "uppercase",
                    border: "2px solid #1C2B4A", cursor: "pointer", transition: "all 0.25s",
                  }}
          ...
          <FadeUp>
            <div style={{ maxWidth: 680, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 10 }}>
              ...
              <h2 style={{ fontFamily: "'Cormorant Garamond',Georgia,serif", fontSize: "clamp(28px,3.5vw,46px)", fontWeight: 700, color: "#fff", lineHeight: 1.2, marginBottom: 14 }}>
                ...
                <em style={{ color: "#C0145C", fontStyle: "italic", fontWeight: 400 }}>to Choose?</em>
              </h2>
              <p style={{ fontSize: 15, color: "rgba(255,255,255,0.45)", marginBottom: 38, lineHeight: 1.82, fontWeight: 300 }}>
                Our expert team will guide you to the right specialist within minutes.
                Call us or book online — available across all 5 Srikara branches in Hyderabad.
              </p>
              <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
                <Link href="/doctors">
                  <button style={{
                    display: "inline-flex", alignItems: "center", gap: 8, padding: "14px 32px",
                    borderRadius: 50, background: "linear-gradient(135deg,#C0145C,#e8457e)",
                    color: "#fff", fontFamily: "'Outfit',sans-serif", fontWeight: 800, fontSize: 12,
                    letterSpacing: "0.09em", textTransform: "uppercase", border: "none", cursor: "pointer",
                    boxShadow: "0 8px 24px rgba(192,20,92,0.42)", transition: "transform 0.25s, box-shadow 0.25s",
                  }}
                    onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 14px 32px rgba(192,20,92,0.55)"; }}
                    onMouseLeave={e => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 8px 24px rgba(192,20,92,0.42)"; }}
                  >
                    <Calendar size={14} /> Book Appointment
                  </button>
                </Link>
                <a href="tel:04046460000">
                  <button style={{
                    ...
                    border: "2px solid rgba(255,255,255,0.3)", cursor: "pointer", transition: "background 0.22s",
                  }}
                    onMouseEnter={e => e.currentTarget.style.background = "rgba(255,255,255,0.1)"}
                    onMouseLeave={e => e.currentTarget.style.background = "transparent"}
                  >
