    ...
    <>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        :root {
          /* ── SRIKARA LOGO EXACT COLOURS ── */
          /* Deep navy from "SRIKARA" wordmark */
          --navy:         #1B2D5B;
          --navy-dk:      #111D3A;
          --navy-dkr:     #0C1528;
          --navy-lt:      #2A4480;
          ...
          /* Magenta / deep pink from "HOSPITALS" text + flower emblem */
          --pink:         #A3195B;
          --pink-dk:      #75124200;
          --pink-dark:    #751242;
          --pink-lt:      #C2206D;
        ...
        .hero-cta:hover {
          background: var(--pink-lt); transform: translateY(-3px);
          box-shadow: 0 14px 38px rgba(163,25,91,0.55);
        }
        ...
        .ring {
          ...
          border: 1px solid rgba(163,25,91,0.22);
        }
        ...
        .story-text p {
          font-size: 16px; line-height: 1.9; color: var(--text-mid); margin-bottom: 22px;
        }
        .story-quote {
        ...
        .value-card:hover {
          ...
          box-shadow: 0 20px 44px rgba(27,45,91,0.14);
        }
        ...
        /* ═══════════════════════════════
           BRANCHES — 9 branches, 3-col grid
        ═══════════════════════════════ */
        ...
        .branch-card:hover:not(.active)::before,
        .branch-card.active::before { transform: scaleX(1); }
        .branch-card:hover:not(.active) {
          border-color: rgba(27,45,91,0.28);
          box-shadow: 0 8px 24px rgba(27,45,91,0.1);
          background: var(--white);
        }
        .branch-card.active {
          background: var(--navy-dk); border-color: var(--navy-dk);
          color: var(--white); box-shadow: 0 16px 40px rgba(27,45,91,0.28);
        }
        .branch-num {
        ...
        .branch-area {
          font-size: 12px; margin-bottom: 14px; font-weight: 600;
        }
        ...
        .leader-card:hover {
          background: rgba(163,25,91,0.1); border-color: rgba(163,25,91,0.35);
        ...
        .leader-name {
          font-size: 17px; font-weight: 700; margin-bottom: 7px;
          font-family: 'Playfair Display', serif;
        }
        .leader-role {
          color: var(--pink-glow); font-size: 10px; text-transform: uppercase;
          letter-spacing: 1.5px; margin-bottom: 10px; font-weight: 800;
        }
        ...
        .cta-tagline::after {
          ...
          background: rgba(249,168,212,0.5); border-radius: 2px;
        }
        .cta-title {
          font-family: 'Playfair Display', serif; font-size: clamp(36px, 4vw, 52px);
        ...
        .cta-btn-primary:hover {
          background: var(--pink-lt); transform: translateY(-3px);
          box-shadow: 0 16px 36px rgba(163,25,91,0.6);
        }
        .cta-btn-secondary {
