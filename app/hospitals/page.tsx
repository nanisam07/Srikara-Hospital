...
function FadeUp({ children, delay = 0, style = {} }: { children: React.ReactNode; delay?: number; style?: React.CSSProperties }) {
  ...
  return (
    <div ref={ref} style={{ opacity: inView ? 1 : 0, transform: inView ? "translateY(0)" : "translateY(32px)", transition: `opacity 0.75s ease ${delay}ms, transform 0.75s ease ${delay}ms`, ...style }}>
      {children}
    </div>
  );
}
...
═══════════════════════════════════════════ */
const HOSPITALS = [
  { id: 1,  name: "RTC 'X' Roads",  fullName: "Srikara Hospitals — RTC X Roads",    location: "RTC X Roads, Hyderabad",        phone: "040 4646 0000", slug: "rtc-x-roads",    beds: 350, tag: "Flagship",    nabh: true,  specialty: "Robotic Surgery · Cardiology · Neurology",   color: "#C0145C", accent: "#e8457e",  hours: "24/7",    img: "rtc-x-roads.jpeg",     mapLink: "https://maps.google.com", tags: ["NABH","Flagship","Robotic"],              featured: true  },
  { id: 2,  name: "Miyapur",         fullName: "Srikara Hospitals — Miyapur",         location: "Miyapur X Roads, Hyderabad",    phone: "040 4747 0000", slug: "miyapur",         beds: 250, tag: "NABH",       nabh: true,  specialty: "Orthopaedics · Cardiac Care",                color: "#1C2B4A", accent: "#4A6FA5",  hours: "24/7",    img: "Miyapur.jpeg",         mapLink: "https://maps.google.com", tags: ["NABH","ISO 9001"],                        featured: false },
  { id: 3,  name: "LB Nagar",        fullName: "Srikara Hospitals — LB Nagar",        location: "LB Nagar, Hyderabad",           phone: "040 66 000 108",slug: "lb-nagar",        beds: 280, tag: "Multi-spec", nabh: true,  specialty: "Oncology · Gastroenterology",                color: "#0A7A6A", accent: "#13a892",  hours: "24/7",    img: "Lbnagar.jpeg",         mapLink: "https://maps.google.com", tags: ["NABH","Cancer Centre"],                   featured: false },
  { id: 4,  name: "Vijayawada",      fullName: "Srikara Hospitals — Vijayawada",      location: "Vijayawada, Andhra Pradesh",    phone: "772 999 0003",  slug: "vijayawada",      beds: 320, tag: "Cardiac",    nabh: true,  specialty: "Cardiac Surgery · Neurosciences",            color: "#C0145C", accent: "#C9933A",  hours: "24/7",    img: "Vijayavada.jpeg",      mapLink: "https://maps.google.com", tags: ["NABH","Cath Lab"],                        featured: true  },
  { id: 5,  name: "ECIL",            fullName: "Srikara Hospitals — ECIL",            location: "ECIL X Roads, Hyderabad",       phone: "040 41 108 108",slug: "ecil",            beds: 200, tag: "ISO 9001",   nabh: false, specialty: "General Medicine · Urology",                 color: "#4A3D8A", accent: "#7B6EC0",  hours: "24/7",    img: "/ecil.jpeg",           mapLink: "https://maps.google.com", tags: ["ISO 9001","24/7 ER"],                     featured: false },
  { id: 6,  name: "Kompally",        fullName: "Srikara Hospitals — Kompally",        location: "Kompally, Secunderabad",        phone: "040 6818 0000", slug: "kompally",        beds: 180, tag: "Multi-spec", nabh: false, specialty: "Pulmonology · Dermatology",                  color: "#1C2B4A", accent: "#4A6FA5",  hours: "24/7",    img: "kompally.jpeg",        mapLink: "https://maps.google.com", tags: ["Multi-spec","24/7 ER"],                   featured: false },
  { id: 7,  name: "Peerzadiguda",    fullName: "Srikara Hospitals — Peerzadiguda",    location: "Peerzadiguda, Hyderabad",       phone: "040 68 108 108",slug: "peerzadiguda",    beds: 160, tag: "Community",  nabh: false, specialty: "ENT · Physiotherapy · Dental",               color: "#0A7A6A", accent: "#13a892",  hours: "8am–10pm",img: "peerzadiguda.jpeg",    mapLink: "https://maps.google.com", tags: ["Community","Diagnostics"],                featured: false },
  { id: 8,  name: "Lakdikapul",      fullName: "Srikara Hospitals — Lakdikapul",      location: "Lakdikapul, Hyderabad",         phone: "040 6969 0000", slug: "lakdikapul",      beds: 220, tag: "NABH",       nabh: true,  specialty: "Nephrology · Mother & Child",                color: "#C9933A", accent: "#e0b050",  hours: "24/7",    img: "ladikapul.jpeg",       mapLink: "https://maps.google.com", tags: ["NABH","Mother & Child"],                  featured: false },
  { id: 9,  name: "Rajahmundry",     fullName: "Srikara Hospitals — Rajahmundry",     location: "Rajahmundry, Andhra Pradesh",   phone: "0883 6818 000", slug: "rajahmundry",     beds: 240, tag: "Cardiac",    nabh: true,  specialty: "Cardiac Care · Oncology",                    color: "#C0145C", accent: "#e8457e",  hours: "24/7",    img: "Rajhamundry.jpeg",     mapLink: "https://maps.google.com", tags: ["NABH","Cath Lab","Cancer"],               featured: false },
];
...
function HospitalCard({ hosp, index }: { hosp: typeof HOSPITALS[0]; index: number }) {
  ...
  return (
    <div ref={ref} style={{ opacity: inView ? 1 : 0, transform: inView ? "translateY(0)" : "translateY(28px)", transition: `opacity 0.65s ease ${(index % 3) * 90}ms, transform 0.65s ease ${(index % 3) * 90}ms` }}>
      <Link href={`/hospitals/${hosp.slug}`}>
        <div onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)}
          style={{ background: "#fff", borderRadius: 26, overflow: "hidden",
            border: `1px solid ${hovered ? hosp.color + "44" : "#EDE8F0"}`, cursor: "pointer",
            transform: hovered ? "translateY(-7px)" : "translateY(0)",
            boxShadow: hovered ? `0 28px 56px rgba(28,43,74,0.14), 0 0 0 1px ${hosp.color}22` : "0 2px 14px rgba(0,0,0,0.05)",
            transition: "all 0.38s ease" }}>
          <div style={{ height: 190, overflow: "hidden", position: "relative" }}>
            <img src={hosp.img} alt={hosp.name} style={{ width: "100%", height: "100%", objectFit: "cover", display: "block", transform: hovered ? "scale(1.06)" : "scale(1)", transition: "transform 0.65s ease" }} />
            <div style={{ position: "absolute", inset: 0, background: `linear-gradient(to top, ${hosp.color}cc 0%, rgba(28,43,74,0.3) 50%, transparent 100%)` }} />
            <div style={{ position: "absolute", top: 14, left: 14, right: 14, display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
              {hosp.featured && <span style={{ fontSize: 8, fontWeight: 900, letterSpacing: "0.2em", textTransform: "uppercase", padding: "4px 12px", borderRadius: 50, background: "#C9933A", color: "#fff" }}>⭐ Featured</span>}
              {hosp.nabh && <span style={{ fontSize: 8, fontWeight: 900, letterSpacing: "0.16em", textTransform: "uppercase", padding: "4px 12px", borderRadius: 50, background: "rgba(255,255,255,0.15)", color: "#fff", backdropFilter: "blur(8px)", border: "1px solid rgba(255,255,255,0.25)", marginLeft: "auto" }}>NABH ✓</span>}
            </div>
            <div style={{ position: "absolute", bottom: 14, left: 16, right: 16 }}>
              <h3 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 20, fontWeight: 700, color: "#fff", lineHeight: 1.1, marginBottom: 4, textShadow: "0 2px 8px rgba(0,0,0,0.3)" }}>{hosp.fullName.replace("Srikara Hospitals — ", "")}</h3>
              <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
                <MapPin size={10} color="rgba(255,255,255,0.7)" />
                <span style={{ fontSize: 10, color: "rgba(255,255,255,0.72)", fontWeight: 500 }}>{hosp.location}</span>
              </div>
            </div>
          </div>
          <div style={{ padding: "18px 20px 16px" }}>
            <p style={{ fontSize: 11, color: "#6B7280", marginBottom: 14, lineHeight: 1.5 }}>{hosp.specialty}</p>
            <div style={{ display: "flex", gap: 0, marginBottom: 16, background: "#F8F6F9", borderRadius: 14, overflow: "hidden" }}>
              {[{ icon: <BedDouble size={13} />, val: `${hosp.beds}`, lbl: "Beds" }, { icon: <Clock size={13} />, val: hosp.hours, lbl: "Hours" }, { icon: <Phone size={13} />, val: "Helpline", lbl: hosp.phone.split(" ")[0] + "..." }].map((s, si) => (
                <div key={s.lbl} style={{ flex: 1, padding: "10px 8px", textAlign: "center", borderRight: si < 2 ? "1px solid #EDE8F0" : "none" }}>
                  <div style={{ display: "flex", justifyContent: "center", color: hosp.color, marginBottom: 3 }}>{s.icon}</div>
                  <div style={{ fontSize: 11, fontWeight: 800, color: "#1C2B4A", lineHeight: 1 }}>{s.val}</div>
                  <div style={{ fontSize: 8, color: "#9CA3AF", textTransform: "uppercase", letterSpacing: "0.1em", marginTop: 2 }}>{s.lbl}</div>
                </div>
              ))}
            </div>
            <div style={{ display: "flex", gap: 6, flexWrap: "wrap", marginBottom: 14 }}>
              {hosp.tags.map((t) => (
                <span key={t} style={{ fontSize: 8, fontWeight: 800, letterSpacing: "0.12em", textTransform: "uppercase", padding: "4px 10px", borderRadius: 6, background: `${hosp.color}12`, color: hosp.color, border: `1px solid ${hosp.color}28` }}>{t}</span>
              ))}
            </div>
            <div style={{ display: "flex", gap: 8, borderTop: "1px solid #F3F4F6", paddingTop: 14 }}>
              <button onClick={(e) => { e.stopPropagation(); window.location.href = `tel:${hosp.phone}`; }}
                style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 6, padding: "10px", borderRadius: 12, border: `1px solid ${hosp.color}28`, background: `${hosp.color}08`, color: hosp.color, fontSize: 10, fontWeight: 800, cursor: "pointer" }}>
                <Phone size={11} /> Call
              </button>
              {hosp.mapLink ? (
  <a
  ...
  >
    <MapPin size={11} /> Directions
              ...
              <div style={{ width: 40, height: 40, borderRadius: 12, background: hovered ? hosp.color : "#F8F6F9", display: "flex", alignItems: "center", justifyContent: "center", color: hovered ? "#fff" : "#9CA3AF", fontSize: 14, transition: "all 0.28s", flexShrink: 0 }}>→</div>
            </div>
          </div>
        </div>
      </Link>
...
export default function HospitalsPage() {
  ...
  const filtered = HOSPITALS.filter((h) => {
    const matchSearch = h.name.toLowerCase().includes(search.toLowerCase()) || h.location.toLowerCase().includes(search.toLowerCase()) || h.specialty.toLowerCase().includes(search.toLowerCase());
    const matchCity = activeCity === "All" || (activeCity === "NABH" && h.nabh) || h.location.toLowerCase().includes(activeCity.toLowerCase());
  ...
  const css = `
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .hp-filter {
      ...
      cursor: pointer; border: 2px solid transparent; transition: all 0.22s;
    }
    ...
    .hp-search:focus { border-color: #C0145C; box-shadow: 0 0 0 4px rgba(192,20,92,0.08); }
    ...
    .hp-btn-primary {
      ...
      background: linear-gradient(135deg,#C0145C,#e8457e); color: #fff;
      ...
      box-shadow: 0 8px 24px rgba(192,20,92,0.36); transition: transform 0.25s, box-shadow 0.25s;
    ...
    .hp-btn-outline {
      ...
      background: transparent; color: #fff; font-family: 'Outfit', sans-serif; font-weight: 700;
      font-size: 12px; letter-spacing: 0.09em; text-transform: uppercase;
      border: 2px solid rgba(255,255,255,0.32); cursor: pointer; transition: background 0.22s; text-decoration: none;
    }
    ...
    .hp-hero-inner {
      ...
      padding: 110px 8vw 80px; width: 100%;
      display: grid; grid-template-columns: 1fr 1fr;
      gap: 64px; align-items: center;
    }
    .hp-hero-mosaic {
      display: grid; grid-template-columns: 1fr 1fr;
      grid-template-rows: 220px 180px; gap: 12px;
    }

    /* ── Quick directory tiles ── */
    .hp-dir-grid {
      display: grid;
    ...
    /* ── Why Srikara 3 pillars ── */
    .hp-pillars-grid { display: grid; grid-template-columns: repeat(3,1fr); gap: 24px; }

    /* ── Hospital cards grid ── */
    .hp-cards-grid { display: grid; grid-template-columns: repeat(3,1fr); gap: 26px; }
    ...
    .hp-search-wrap { position: relative; width: 280px; }

    /* ═══════════════════════
       TABLET 768–1099px
    ═══════════════════════ */
    @media(max-width:1099px){
      .hp-hero-inner      { grid-template-columns:1fr; gap:40px; padding:80px 6vw 60px; }
      ...
      .hp-dir-grid        { grid-template-columns:repeat(5,minmax(110px,1fr)); }
    }
    ...
    @media(max-width:767px){
      .hp-hero-inner      { padding:72px 5vw 48px; }
      .hp-pillars-grid    { grid-template-columns:1fr; gap:16px; }
      .hp-cards-grid      { grid-template-columns:1fr; }
      .hp-services-grid   { grid-template-columns:repeat(2,1fr); gap:12px; }
      .hp-dir-grid        { grid-template-columns:repeat(3,minmax(110px,1fr)); }
      .hp-search-row      { flex-direction:column; align-items:flex-start; }
      .hp-search-wrap     { width:100%; }
      .hp-filter          { padding:7px 14px; font-size:10px; }
      .hp-cta-section     { padding:56px 5vw !important; margin:0 4vw 40px !important; }
    }
    ...
    @media(max-width:399px){
      ...
      .hp-dir-grid        { grid-template-columns:repeat(2,minmax(100px,1fr)); }
    }
  `;
  ...
  return (
    <>
      ...
      <div style={{ background: "#F8F6F9", minHeight: "100vh" }}>
        ...
        {/* ══ §1 HERO ══ */}
        <section style={{ position: "relative", overflow: "hidden", background: "#1C2B4A", minHeight: 580, display: "flex", alignItems: "center" }}>
          ...
          <div className="hp-hero-inner">
            ...
            <div>
              ...
              <div className="hp-hero-h1" style={{ fontSize:10,fontWeight:800,letterSpacing:"0.4em",textTransform:"uppercase",color:"#C0145C",marginBottom:14 }}>9 Hospitals Across TS & AP</div>
              <h1 className="hp-hero-h1" style={{ fontFamily:"'Cormorant Garamond',Georgia,serif", fontSize:"clamp(32px,4.8vw,64px)", fontWeight:700, color:"#fff", lineHeight:1.08, marginBottom:18 }}>
                A Hospital Near<br /><em style={{ color:"#C0145C",fontStyle:"italic",fontWeight:400 }}>Wherever You Are</em>
              </h1>
              <p className="hp-hero-sub" style={{ fontSize:15,color:"rgba(255,255,255,.55)",lineHeight:1.82,marginBottom:36,maxWidth:460,fontWeight:300 }}>
                Srikara Hospitals spans 9 locations across Telangana and Andhra Pradesh — delivering world-class medical care with NABH-certified quality, cutting-edge infrastructure and 300+ specialists.
              </p>
              <div className="hp-hero-btns" style={{ display:"flex",gap:14,flexWrap:"wrap",marginBottom:44 }}>
                <Link href="/doctors" className="hp-btn-primary"><Calendar size={14} /> Book Appointment</Link>
                <a href="tel:1800-123-4567" className="hp-btn-outline"><Phone size={13} /> Emergency: 1800-123-4567</a>
              </div>
              <div className="hp-hero-stat" style={{ display:"flex",gap:28,flexWrap:"wrap" }}>
                {[{ n:"9", l:"Hospitals" }, { n:"2,200+", l:"Total Beds" }, { n:"24/7", l:"Emergency" }, { n:"NABH", l:"Accredited" }].map(s => (
                  <div key={s.l}>
            ...
            <div className="hp-hero-img hp-hero-mosaic">
          ...
          <div style={{ maxWidth:1300,margin:"0 auto" }}>
            <FadeUp>
              <div style={{ textAlign:"center",marginBottom:40 }}>
                ...
                <h2 style={{ fontFamily:"'Cormorant Garamond',Georgia,serif",fontSize:"clamp(22px,2.8vw,38px)",fontWeight:700,color:"#1C2B4A" }}>
              ...
              {HOSPITALS.map((h, i) => (
                <FadeUp key={h.id} delay={i * 55}>
                  <Link href={`/hospitals/${h.slug}`}>
                    <div style={{ padding:"18px 12px",borderRadius:0,borderRight:"1px solid #F0ECF4",cursor:"pointer",textAlign:"center",transition:"background 0.22s",background:"transparent" }}
                      onMouseEnter={(e) => (e.currentTarget.style.background = `${h.color}08`)}
                      onMouseLeave={(e) => (e.currentTarget.style.background = "transparent")}>
                      <div style={{ width:36,height:36,borderRadius:12,background:`${h.color}14`,display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 8px",fontSize:15 }}>🏥</div>
                      <div style={{ fontSize:11,fontWeight:800,color:"#1C2B4A",marginBottom:3,lineHeight:1.2 }}>{h.name}</div>
                      <div style={{ fontSize:9,color:"#9CA3AF",marginBottom:5,lineHeight:1.4 }}>{h.location.split(",")[0]}</div>
                      <span onClick={(e) => { e.stopPropagation(); window.location.href = `tel:${h.phone}`; }} style={{ fontSize:9,fontWeight:800,color:h.color,letterSpacing:"0.06em",cursor:"pointer" }}>{h.phone}</span>
                    </div>
                  </Link>
                </FadeUp>
              ))}
            ...
            <div className="hp-pillars-grid">
              {[
                ...
                <FadeUp key={p.title} delay={i * 100}>
                  <div style={{ borderRadius:24,overflow:"hidden",border:"1px solid #EDE8F0",background:"#fff",transition:"transform 0.35s,box-shadow 0.35s" }}
        ...
        <section style={{ padding:"80px 8vw 100px",background:"#F8F6F9" }}>
          <div style={{ maxWidth:1300,margin:"0 auto" }}>
            <FadeUp>
              <div className="hp-search-row">
                <div>
                  ...
                  <h2 style={{ fontFamily:"'Cormorant Garamond',Georgia,serif",fontSize:"clamp(22px,3vw,42px)",fontWeight:700,color:"#1C2B4A" }}>
            ...
            <div className="hp-cards-grid">
              {filtered.map((h, i) => <HospitalCard key={h.id} hosp={h} index={i} />)}
            </div>
            {filtered.length === 0 && (
          ...
          <div style={{ maxWidth:1300,margin:"0 auto" }}>
            <FadeUp>
              <div style={{ textAlign:"center",marginBottom:52 }}>
                ...
                <h2 style={{ fontFamily:"'Cormorant Garamond',Georgia,serif",fontSize:"clamp(22px,3vw,40px)",fontWeight:700,color:"#1C2B4A" }}>
            ...
            <div className="hp-services-grid">
              {[
                ...
                <FadeUp key={s.title} delay={i * 60}>
                  <div style={{ background:"#F8F6F9",borderRadius:20,overflow:"hidden",border:"1px solid #EDE8F0",transition:"transform .35s,box-shadow .35s" }}
        ...
        {/* ══ §7 CTA ══ */}
        <section className="hp-cta-section" style={{ margin:"0 5vw 60px",borderRadius:36,overflow:"hidden",position:"relative",background:"#1C2B4A",padding:"80px 8vw" }}>
          ...
          <FadeUp>
            <div style={{ maxWidth:660,margin:"0 auto",textAlign:"center",position:"relative",zIndex:10 }}>
              ...
              <h2 style={{ fontFamily:"'Cormorant Garamond',Georgia,serif",fontSize:"clamp(24px,3.5vw,46px)",fontWeight:700,color:"#fff",lineHeight:1.2,marginBottom:14 }}>
                A Srikara Hospital Is <em style={{ color:"#C0145C",fontStyle:"italic",fontWeight:400 }}>Always Nearby</em>
              </h2>
              <p style={{ fontSize:15,color:"rgba(255,255,255,.42)",marginBottom:38,lineHeight:1.82,fontWeight:300 }}>
                9 hospitals. 2,200+ beds. 300+ specialists. Whether it's a routine check-up or a life-saving emergency — Srikara is here for you, 24 hours a day, 7 days a week.
              </p>
              <div style={{ display:"flex",gap:14,justifyContent:"center",flexWrap:"wrap" }}>
                <Link href="/doctors" className="hp-btn-primary"><Calendar size={14} /> Book Appointment</Link>
                <a href="tel:1800-123-4567" className="hp-btn-outline"><Phone size={13} /> 1800-123-4567</a>
              </div>
              <div style={{ marginTop:36,display:"flex",alignItems:"center",justifyContent:"center",gap:12,padding:"14px 24px",borderRadius:50,background:"rgba(192,20,92,.1)",border:"1px solid rgba(192,20,92,.22)",width:"fit-content",margin:"36px auto 0" }}>
                ...
                <span style={{ fontSize:12,fontWeight:800,color:"rgba(255,255,255,.75)",letterSpacing:"0.06em" }}>🚑 Ambulance: 9609108108 &nbsp;·&nbsp; 24/7 All 9 Hospitals</span>
              </div>
            </div>
          </FadeUp>
        </section>
